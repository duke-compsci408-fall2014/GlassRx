...
public class SetTimerActivity extends Activity implements BaseListener, ScrollListener,
    ...
    /** Updates the various {@link android.widget.TextView} with the current Timer value. */
    ...
    /**
     * Keeps the time between 0 and {MAX_TIME_SECONDS}.
     */
    ...
    /**
     * Sets the {@link android.app.Activity} result, overridable for testing.
     */
