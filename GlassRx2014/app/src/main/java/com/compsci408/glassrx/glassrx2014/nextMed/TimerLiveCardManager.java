/*
 * Modified and reused with permission by William Knowles, 2014
 *
...
package com.compsci408.glassrx.glassrx2014.nextMed;
...
/**
 * Class to manage {@link com.google.android.glass.timeline.LiveCard} for the {@link TimerService}.
 */
public class TimerLiveCardManager {
    ...
    /** Starts a new {@link Timer}/{@link com.google.android.glass.timeline.LiveCard} combination with the provided duration. */
    public Timer startNewTimer(long durationMillis) {
        ...
        Intent menuIntent = new Intent(mContext, MenuActivity2.class);
    ...
    /**
     * Stops the {@link Timer}/{@link com.google.android.glass.timeline.LiveCard} and returns whether or not the manager is empty of
     * {@link Timer}.
     */
    ...
    /** Returns the {@link com.google.android.glass.timeline.LiveCard} associated with this {@link Timer}. */
